...
async function main() {
  ...
  const submissions = demos.map((demo) => ({
    ...
    pocLinkedin: "https://www.linkedin.com/in/adalovelace",
    companyLinkedin: "https://www.linkedin.com/company/aicollective",
    demoUrl: demo.url,
    demoNotes: "Skip to 0:45 for the live agent run.",
